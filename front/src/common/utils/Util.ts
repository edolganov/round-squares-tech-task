...
import { lastFrom } from './collection/lastFrom';
...
import { ascSort } from './collection/ascSort';
import { descSort } from './collection/descSort';
import { randomInt } from './math/randomInt';
import { onAsyncErr } from './promise/onAsyncErr';
